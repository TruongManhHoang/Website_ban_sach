...
<%
   ...
   %>
    ...
    <% 
    	...
    	String hoVaTen = qt.getTen();
    	String gioiTinh = qt.getGioiTinh();
    	Date ngaySinh = qt.getNgaySinh();
    	String soDienThoai = qt.getSdt();
    	String diaChi = qt.getDiaChi();
    	String mail = qt.getEmail();
%>
	...
	<div class="container">
		...
		<form class="form" action="<%=url %>/quantrivienController" method="post">
		    <input type="hidden" value="thongtinkhachhang" name="controller" id="thongtinkhachhang"/>
			<div class="row">
				<div class="col-sm-6">
