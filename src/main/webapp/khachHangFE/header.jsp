					...
					%>    	
						...
						<li class="nav-item dropdown dropstart"><a
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="<%=url %>/khachHangFE/thayDoiAnh.jsp">Thay avatar</a></li>
								<li><a class="dropdown-item" href="<%=url %>/khachHangFE/thongtinkhachhang.jsp">Thông
										tin khách hàng</a></li>
								<li><a class="dropdown-item" href="<%=url %>/khachHangFE/doimatkhau.jsp">Đổi mật khẩu</a></li>
								<li><hr class="dropdown-divider"></li>
